...
return [
    ...
    'extensions' => 'Fältet :attribute måste ha en av följande ändelser: :values.',
    ...
    'not_regex' => 'Fältet :attribute har ett ogiltigt format.',
    ...
    'password' => [
        ...
        'symbols' => 'Fältet :attribute måste innehålla minst ett symbol.',
        'uncompromised' => 'Det angivna :attribute har förekommit i en dataläcka. Vänligen välj ett annat :attribute.',
    ],
    ...
    'present_with' => 'Fältet :attribute måste vara närvarande när :values finns.',
    'present_with_all' => 'Fältet :attribute måste vara närvarande när :values finns.',
    ...
    'prohibits' => 'Fältet :attribute förbjuder att :other finns.',
    'regex' => 'Fältet :attribute har ett ogiltigt format.',
    ...
    'attributes' => [
        'coConMemberIds' => 'co-conscious medlemmar',
        'email' => 'e-postadress',
        'frontComment' => 'frontkommentar',
        'inviteEmail' => 'inbjudnings-e-post',
        'inviteRole' => 'inbjudningsroll',
        'selectedMemberIds' => 'valda medlemmar',
    ],
];
